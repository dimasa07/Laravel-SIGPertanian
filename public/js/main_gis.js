...
//var centerView = new L.LatLng(-6.8871, 107.615515);
var centerView = new L.LatLng(-6.869885, 107.617707);
...
var listSawahButton = L.easyButton({
    id: 'list-polyline',
    states: [{
        icon: 'fas fa-book',
        title: 'Lihat Daftar Sawah',
        stateName: 'list-polyline',
        onClick: (btn, map) => {
            switchTab();
            // window.location.href = window.location.origin + "/admin/list";
        }
    }]
});
listSawahButton.addTo(mymap);
...
function switchTab(){
    ...
    tab1.style.display = displayTab1;
    tab2.style.display = displayTab2;
    footer.style.display = displayTab1;
}
